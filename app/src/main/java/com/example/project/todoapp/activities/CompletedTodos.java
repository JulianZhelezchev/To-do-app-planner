...
import com.example.project.todoapp.adapters.CompletedTodoAdapter;
import com.example.project.todoapp.helpers.TodoDBHelper;
import com.example.project.todoapp.models.CompletedTodoModel;
        ...
        builder.setPositiveButton("Delete All", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                if(todoDBHelper.removeCompletedTodos()){
                    ...
                    Toast.makeText(CompletedTodos.this, "All Completed  are todos deleted !", Toast.LENGTH_SHORT).show();
                }
            }
        }).setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                Toast.makeText(CompletedTodos.this, "Todos are not deleted !", Toast.LENGTH_SHORT).show();
            }
        }).create().show();
    }
}

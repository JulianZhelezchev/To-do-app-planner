...
import com.example.project.todoapp.adapters.PendingTodoAdapter;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,
    ...
    //show add new todos dialog and add the todos into the database
    private void showNewTodoDialog(){
        ...
        //setting dropdown view resource for spinner
        ...
        //gets the to-do-date of the task
        ...
        //gets the to-dos time of the task
        ...
        addTodo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //checs the data fields if they are empty
